...
const STEPS = [
  ...
  },
  {
    ...
    text: 'На дашборде — актуальный курс золота, ключевые показатели и последние сделки. В калькуляторе быстро считаете выкуп по весу и пробе, затем переходите в договор.',
    icon: (
