      ...
      <main className="pp-main">
        <article className="pp-article">
          ...
          <section>
            ...
            <p>
              При первом заходе на публичные страницы сайта показывается уведомление о файлах cookie и аналитике.
              Нажатие «Согласен» подтверждает согласие на cookie и Яндекс Метрику. Счётчик аналитики загружается
              только после этого согласия.
            </p>
          </section>
